...
class PresetManager {
    ...
    startNew() {
        ...
        svtParamsForm.write(svtParamsForm.presetIds(), current.svt_params);
    ...
    startEdit(id) {
        ...
        svtParamsForm.write(svtParamsForm.presetIds(), preset.svt_params || '');
    ...
    async saveEdit() {
        const payload = {
            ...
            svt_params: svtParamsForm.read(svtParamsForm.presetIds()),
